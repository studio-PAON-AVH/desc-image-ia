...
- [Manuel de déploiement](docs/manuels/deploiement.md) — procédure de mise en production sur un VPS
- [Manuel d'utilisation](docs/manuels/utilisation.md) — prise en main de l'application par les utilisateurs
